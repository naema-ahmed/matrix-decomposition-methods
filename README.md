...
**Overview:**
- Implemented LU, QR (Gram–Schmidt), SVD, and Schur decompositions from scratch in MATLAB
- Built the Schur decomposition using an iterative QR algorithm, reusing the custom QR implementation
- Constructed SVD via the Schur decomposition applied to A^T*A, rather than relying on built-in functions
...
- Presented results and interpretations in a structured technical report
